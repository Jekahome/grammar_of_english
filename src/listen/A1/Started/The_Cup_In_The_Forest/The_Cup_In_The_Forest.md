...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/The_Cup_In_The_Forest/The_Cup_In_The_Forest.vtt";
        const audio = "/listen/A1/Started/The_Cup_In_The_Forest/The_Cup_In_The_Forest.opus";
