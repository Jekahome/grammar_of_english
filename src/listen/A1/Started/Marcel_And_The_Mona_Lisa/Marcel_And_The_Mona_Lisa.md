...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/Marcel_And_The_Mona_Lisa/Marcel_And_The_Mona_Lisa.vtt";
        const audio = "/listen/A1/Started/Marcel_And_The_Mona_Lisa/Marcel_And_The_Mona_Lisa.opus";
