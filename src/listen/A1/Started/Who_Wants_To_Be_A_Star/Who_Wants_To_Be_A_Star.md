...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/Who_Wants_To_Be_A_Star/Who_Wants_To_Be_A_Star.vtt";
        const audio = "/listen/A1/Started/Who_Wants_To_Be_A_Star/Who_Wants_To_Be_A_Star.opus";
