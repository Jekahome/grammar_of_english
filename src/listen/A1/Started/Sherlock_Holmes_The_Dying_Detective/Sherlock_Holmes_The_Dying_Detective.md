...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/Sherlock_Holmes_The_Dying_Detective/Sherlock_Holmes_The_Dying_Detective.vtt";
        const audio = "/listen/A1/Started/Sherlock_Holmes_The_Dying_Detective/Sherlock_Holmes_The_Dying_Detective.opus";
