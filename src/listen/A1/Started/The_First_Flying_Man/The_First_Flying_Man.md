...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/The_First_Flying_Man/The_First_Flying_Man.vtt";
        const audio = "/listen/A1/Started/The_First_Flying_Man/The_First_Flying_Man.opus";
