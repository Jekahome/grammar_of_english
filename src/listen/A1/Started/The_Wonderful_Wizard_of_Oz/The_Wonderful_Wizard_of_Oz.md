...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/The_Wonderful_Wizard_of_Oz/The_Wonderful_Wizard_of_Oz.vtt";
        const audio = "/listen/A1/Started/The_Wonderful_Wizard_of_Oz/The_Wonderful_Wizard_of_Oz.opus";
