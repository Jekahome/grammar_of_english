...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Started/The_Mystery_Of_Manor_Hall/The_Mystery_Of_Manor_Hall.vtt";
        const audio = "/listen/A1/Started/The_Mystery_Of_Manor_Hall/The_Mystery_Of_Manor_Hall.opus";
