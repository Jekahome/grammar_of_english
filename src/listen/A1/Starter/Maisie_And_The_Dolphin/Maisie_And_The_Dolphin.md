...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Starter/Maisie_And_The_Dolphin/Maisie_And_The_Dolphin.vtt";
        const audio = "/listen/A1/Starter/Maisie_And_The_Dolphin/Maisie_And_The_Dolphin.opus";
