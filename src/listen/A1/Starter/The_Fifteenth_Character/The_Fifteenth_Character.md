...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Starter/The_Fifteenth_Character/The_Fifteenth_Character.vtt";
        const audio = "/listen/A1/Starter/The_Fifteenth_Character/The_Fifteenth_Character.opus";
