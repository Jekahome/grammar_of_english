...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const subtitles = "/listen/A1/Starter/The_Girl_With_Red_Hair/The_Girl_With_Red_Hair.vtt";
        const audio = "/listen/A1/Starter/The_Girl_With_Red_Hair/The_Girl_With_Red_Hair.opus";
