## Понимание задачи изучения языка
 
<details>
<summary>Задачи</summary>

* [ ] Продолжить создавать примеры для практики для "Modal_verbs_can_must_should_will", "Questions_A1"...

* [ ] Если главное - **начать работать с контентом**, то имея основу из базовой грамматики и слов можно уже дальше потреблять разнообразный контент.
  * [ ] начать с прохождения грамматики A1. Какой формат ее прохождения, как работать с материалом что бы считать его пройденым
  * [ ] примеры в уроке "to be" и "to do/to have" что делать с ними (их еще нет в A1 списке примеров). Зачем примеры тогда, если надо на странице грамматики явно тему покрыть
* [x] придумать темы для аудио уроков 
* [ ] Причесать список грамматики для A1 
  * [ ] Причесать уроки для A1 (смотреть что за урок и смотреть в книгах что надо знать из него)
  * [ ] Создать озвученный контент уроков

* [ ] решить как записывать и прослушивать аудио что бы писать под диктовку (с браузера или AI инструментами озвучить)
 
* [ ] Перенести некоторые интерактивные примеры выполнения упражнений из другого проекта Английского, особенно читалка адаптивных книг с подсветкой нужных слов
* [ ] Где найти видео по субтитрам что бы понять к какому уровню его применять для практики?
* [ ] Контент: Мультики, сказки для детей 
* [ ] Слова
  * [ ] На каждое английское слово в A2-C2 делать мини историю где это слово используется часто, идеально - оно или его смысл, и есть тема истории! Тогда легче запомнится за счет контекста.
  * [ ] Учить глаголы можно через круг слова, когда у слова есть другие часто используемые вместе с ним в предложении слова. 
  * [ ] Можно ли создать субтитры и озвучить властелин колец для A1 только словами уровня.
...
* [ ] найти место **использования** языка т.е. где идет практика применения
  * [ ] В адаптивных книгах заменить слова которые не по уровню на нужный уровень
  * [ ] Создать активную практику, после listening нужна активная практика говорить, повторяя за диктором. Начать можно в первых уроках с активного: формирования в мыслях предложений и написания перевода на английских элементарных примерах по данной грамматике и произносить в слух за диктором, в следующих уроках уже учитывать пройденную грамматику. **В конце концов эта активная практика должна привести к закрытию тем для уровня A1... т.е. шаг за шагом мы должны свободно рассуждать на заданные темы (семья, хобби ...)**
  * [ ] А грамматику раз ее не надо зубрить, заучивать но надо понимать, то вместо подстановки верных слов в предложения, **нужно выбирать из списка причин ту или иное грамматическое правило**, т.е. почему это предложение именно так используется? Какое правило ему соответсвует?
* [ ] Нужно иметь: оформленные уроки, примеры для уроков, аудио этих примеров
...
<details>
<summary>Уроки. Предложения для озвучки</summary>
...
## 1. Какие знания необходимы для достижения B2

Для начала необходим примерно 3 тыс. словарный запас (7 тыс. это 80% текста). 
Слова имеют конкретную частоту встречаемости, так что следует начать с самых частотных, сгруппированных по частям речи (глаголы, существительные, наречия и т.д.). 
Также фразовые глаголы — у них тоже есть частота употребления в речи.

Грамматика делится по уровням A1-C2..., противопоказанно ее изучать, заучивать, зубрить. С ней следует **ознакомится** и при надобнасти посматривать, и по мере привыкания к языку, грамматика станет понятной. Конечно уроки следует проходить от одной темы грамматики к другой, т.е. опираясь на нее, она задает тему урока, но язык не нужно изучать, к нему нужно привыкать, его нужно пробовать использовать, а не следовать четким правилам грамматики.

> Я критично отношусь к языковым курсам, на которых рассказывают грамматику, тратя драгоценное время урока, и тут же пытаются ее практиковать со студентами которые испытывают колосальную когнитивную нагрузку, что в свою очередь малоэффективно. Информация должна быть понятной при ее применении, а ознакамливаться с ней лучше заранее самому и лишь на уроке закреплять. Лучше бы студенты подготовились дома с теорией, а на уроке практиковались в речи, и на следующих нескольких уроках повторяли эту же тему снова, доводя ее до уверенного использования. И к тому же, темы уроков четко по уровню и с учетом полученных знаний на предыдущих уроках, все слова и грамматика используемая в уроке должна быть знакома, т.е. пройденна ранее. Конечно новые слова изучаются так же по уровню и снова применяются на следующих уроках словно нарастающий ком снега катящийся с горки, новые слова повторяются снова и снова в следующих уроках, для этого и нужно повторять уроки одной и тойже темы грамматики с разеым набором уже изученных слов и конструкций.
> Если выстроить **в начале то что нужно в начале**, т.е. дать последовательную базу струденту на которую он сможет опирать в любом непонятном случае, то студент будет иметь уверенность в себе и стремиться исследовать дальше, а не молчать и забрасывать учебу. База грамматики это пирамида, в основании самые частоиспользуемые правила и конструкции, выше уже реже используемые. Не нужна в начале грамматика артиклей и их исключения, она нужна только для ознакомления, развеить магию незнания и т.д.
> Так же ошибочно будет смотреть блогеров, которые **обьясняют** английский, т.е. они пытаюся вас научить английскому, как буд то английский это формула из математики, просто бери и подставляй. Но нам же надо **усвоение языка** и **применение** его в активной форме, а не понимать как он устроен и как переводится. Как он устроен вы сами разбираетесь по грамматике, это не занимает много времени, поняли и все, заучивать до дыр нет смысла, а дальше должна идти долгая практика.

Практика состоит из навыков где нужно: ГОВОРИТЬ, СЛУШАТЬ, ПИСАТЬ, ЧИТАТЬ. 
Самый важный навык - это **СЛУШАТЬ** (аудирование), т.е. умение распознавать на слух. Так как зная как звучит английская речь, вы будете иметь пример звучания которому сможете подражать, и будете иметь примерное представление о его написании, т.е. это охватывает все необходимые навыки.

Аудирование (и письмо) развивается через **диктант под диктовку** определенныйх предложений грамматики, от уровня у уровню с набором слов, т.е. все предложения должны состоять из слов, изученных ранее, плюс новых, изучаемых сейчас.

Ни слова, ни словесные конструкции, ни грамматика не запомнятся без необходимого контекста, эмоциональной **добавки** и многократного использования и переодичесткого встречания в окружении. Поэтому необходимо закреплять фоном.

Для закрепления и привыкания подходит пассивный способ: просмотр видео [youtube English A1](https://www.youtube.com/results?search_query=English), [Slow English](https://www.youtube.com/watch?v=xEf8OYRJtws&list=PLTI5VrQW0CazhyD9Kyj7Srs-S1iT0WIul), [Easy English](https://www.youtube.com/watch?v=ri2uKTpw4lQ&list=PL5uXqO84WYGuBKdwWMjxYGmF4am771fxS), [A1 English](https://www.youtube.com/watch?v=hBVequEEoAQ&list=PLv4XgHS4V3TJsIpVSOwhfJ3uexzSCf7QA), [A1 English Listening Practice](https://www.youtube.com/playlist?list=PLhNRdHEdUQewzYZ0X6gt3x9_CVen_HldI), English Comprehensible Input, сериалов по типу Friends, [Extra English](https://www.youtube.com/playlist?list=PLdYSWqTrWP2jyqWIdjsATbrb11uN_BMrF), мультики A1-A2: Finding Nemo, Winnie The Pooh, Up!, Anastasia, Soul, Zootopia, [Educational video lessons for toddlers](https://www.youtube.com/results?search_query=Educational+video+lessons+for+toddlers), простые фильмы: 100 days of Summer. 
...
Но поскольку найти людей, которым было бы интересно обсуждать ваши темы, непросто (например, через приложение HelloTalk), основное время обучения придётся уделять самостоятельной работе.

Возможна компенсация недостатка общения с человеком, используя возможности браузера и библиотек работы с голосом. 
Браузер может выполнять **voice to text** и **text to voice**, эта комбинация может заменить роль тренера. 
Также, вы можете настроить ChatGPT в качестве собеседника для вашего уровня английского.

Но остается проблема с контентом — трудно подобрать обучающий материал по уровню и теме. 
Необходимо показать **контекст** с озвучиванием, в нужной грамматике и с нужными словами. 
...
* Видео фильмы, сериалы, мультики, видео на Youtube: SLOW ENGLISH, EASY ENGLISH A1, English Comprehensible Input (torrents):
 
В идеале иметь видео на определенные темы грамматики с понятным вводом (English Comprehensible Input)

Хуже аудио с хорошей дикцией на определенные темы грамматики с понятным вводом (English Comprehensible Input)

Почему на **определенные** темы? Потому что просто слушать простую речь с целью привыкнуть не так эффективно если привыкнуть к тому что надо в первую очередь, что собственно и поднимет на ступень выше в понимании языка и развеет "туман" непонятности в большинстве случаев, так как именно первые темы самые популярные и простые! Например тема с `to be` и `pronouns` в каждом предложении, так может с них надо начать просмотр видео/аудио, а не с фруктов, динозавров или погоды, времени и местоположения ?

Для этих идеальных данных нужен текст, предложения - где их взять? - Искать в словарях и просить у LLM.

А если писать под диктовку? Тут есть вслушивание и сразу письмо! Ведь понятный ввод предполагает что ты знаком с контентом, поэтому можно и писать его. А слушать непонятный ввод, это только фоном для расслабления.

> Идея, телеграм бот или cron, пушит уведомления вопросы в любое дневное время с вопросом на английском на текущую изучаемую тему. Для роли тренера мотиватора и просто вспомнить
...
### LISTEN (самый важные навык!)
Если можешь услышать то и прочитать сможешь и понять о чем речь, и написать и соответственно понимаешь как должно звучать.

LISTEN (СЛУШАТЬ) — мультики, фильмы, прослушивать адаптивные книги, найти приятный голос блогера. 
Записать аудио в формате "вопрос en — пауза 5 сек — ответ en" и во время прогулки отвечать на эти вопросы. 
...
[Онлайн-диктанты](https://www.learnenglish.de/dictationpage.html#elem), [Онлайн-диктанты](https://www.englishclub.com/listening/dictation.php).
...
### WRITE
WRITE (ПИСАТЬ) — при прослушивании адаптивных книг, при прохождении грамматики по учебникам, отвечать на форумах, вести личный блог о том, как идет изучение языка. 
Составлять простые предложения в различных Simple временах из слов набора A1 и проверять их [грамматику](https://languagetool.org/ru) или [www.onlinecorrection.com](https://www.onlinecorrection.com/).

### SPEAK

SPEAK (ГОВОРИТЬ) — учиться/привыкать следует при чтении вслух и повторяя за диктором с 
...
[Метод Борисова](https://youtu.be/BzIVOhOTtSU?si=lrjTGxR7_w9BmFZd) Понятный ввод, т.е. пытаться услишать английскую речь только если ты уже знаешь как это звучит на русском, а не пытаться угадать/распознать. На этот этап Дениса рекомендует пол года, и только после привыкания к звучанию языка переходить на метод "тени" это когда повторяешь за диктором.
...
Хорошо по началу озвучить предлдожения на простые темы A1 - "to be", "Pronouns"
...
* Повторять эти предложения за диктором, слушать и повторять. [создать аудио](/tools)
...
Слушать надо уже понятные предложения с известными словами и грамматикой, что бы небыло догадок. Тут, мы только привыкаем к звучанию, а не учим новые слова и грамматику!
