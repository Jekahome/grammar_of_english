...
Comprehensible Input - Это когда вы знаете/догадываетесь как звучит каждое слово и его смысл в прослушиваемом аудио контенте. Или же для текста понимаете смысл, перевод слов. А просто знакомый сюжет фильма это не является понятным вводом!
...
Кроме того, носители языка ради беглости и удобства произносят совсем другие звуки либо вообще их не произносят [см. Alphabet](grammar_of_english/A1/Alphabet.html)
...
📺 @PcCentric
Если вам интересна наука, то однозначно вам к этой дамочке:
📺 @DrawCuriosity
```
...
* сериалов по типу: Friends, [Extra English](https://www.youtube.com/playlist?list=PLdYSWqTrWP2jyqWIdjsATbrb11uN_BMrF), 
...
[метод тренера по речи Сергея Че](https://www.youtube.com/watch?v=aqF481MMDcs)
...
Важный нюанс, если понимать значение *всех* слов из A1 (до 1000 слов) то вы **УЖЕ** должны говорить и воспринимать на слух предложения в пределах грамматики A1, состоящие из этих слов, соответственно на это надо делать упор, переносить понимание в использование. 
...
Сперва закрепите понимание на этом уровне, используя **ТОЛЬКО** грамматику для A1, говорите простые предложения, воспринимайте их на слух, пишите под диктовку. Когда вы "вырастете" из этого уровня, у вас будет "тяга" к новому уровню A2.


Метод Дениса Борисова [1](https://youtu.be/BzIVOhOTtSU?si=lrjTGxR7_w9BmFZd) и [2](https://youtu.be/sNkUefjJDGs?is=yXACP9q7HfWtNihb). Понятный ввод (Comprehensible Input), т.е. пытаться услишать английскую речь только если вы уже знаете как это звучит на русском, а не пытаться угадать/распознать. На этот этап, Денис рекомендует пол года, и только после привыкания к звучанию языка переходить на метод "тени" это когда повторяем за диктором.
...
* читая адаптивные книги (starter, Beginner);
...
No, I am not at home. - Нет, меня нет дома.
...
Were you tired yesterday? - Ты вчера устал?
...
Слушать уже понятные предложения с известными словами и грамматикой, что бы не было догадок. Тут, мы только привыкаем к звучанию, а не учим новые слова и грамматику!
...
* Shadowing [www.leonardoenglish.com](https://www.leonardoenglish.com/blog/what-is-shadowing) и записывать свою речь
...
whisper audio.opus --model base.en --language en --output_format vtt --device cpu --word_timestamps True --temperature 0 --beam_size 5 --max_words_per_line 10
