...
* [ ] **3** listen
  * добавить режимы воспроизведения?
    * ручной, переключение следующего временного интервала и повтор
    * автоматический
    * автоматический но с повтором, два, три раза одного временного интервала
  * для закрепления восприятия на слух - Quiz задать вопрос (голосом) на знание сюжета прослушанного контента. 
  * для закрепления восприятия на слух - перефразировать услышанное. (тоже LLM)
  ...
  * есть ли другие темы с хорошей озвучкой, особенно из [тем](A1/List_of_topics_for_speaking_and_writing_practice.html) уровня? (скорее LLM TTS озвучит всю тему, чем найдешь нормальную речь по нужной теме)
