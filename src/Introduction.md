...
* [ ] **1.**  Задействовать [темы](A1/List_of_topics_for_speaking_and_writing_practice.html) для разговора после овладения A1. Добавить практику для их отработки.
* [ ] **2** добавить остальные адаптивные книги с озвучкой
  * есть ли другие темы с хорошей озвучкой, особенно из [тем](A1/List_of_topics_for_speaking_and_writing_practice.html) уровня?
* [ ] **3.** Для практики генерировать на лету предложения, предоставить набор слов в определенной теме грамматики, для конструирования из них предложения. Можно и звуком давать слова. Слова из доступных на момент урока грамматики, а не всех уровнях. С каждым уроком набор слов расширяется, и на конец уровня можно все использовать в упражнениях. Повторение разными способами и усложняя постепенно через скорость и сложность, это для практики так можно начать с понятного ввода и закончить беглостью для любой темы грамматики или фразовых глаголов или неправильных глаголов.

* [ ] Читать на русском и переводить голосом на английский 

* [ ] **5.** Нет применения! слов из набора примеров для Урока 17. (Для выравнивания статистики использования слов) 
* [ ] **6** Для listen не доработано понимание подчеркнутого слова
