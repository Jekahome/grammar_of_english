...
<details>
<summary>Verbs modal A1</summary>

**Основные модальные глаголы**

| Глагол | Перевод | Время | Значение |
|------------|-------------|-------|----------|
| **can** | мочь;уметь | present | способность;возможность;разрешение |
...
| Выражение | Перевод | Время | Значение |
|---------------|-------------|-------|----------|
...
<summary>Irregular Verbs A1</summary>

| Base       | 3rd person  | -ing          | Past       | Past Participle | Перевод                         | Частотность |
| ---------- | ----------- | ------------- | ---------- | --------------- | ------------------------------- | ----------- |
...
| get        | gets        | getting       | got        | gotten          | получать; становиться (амер.)   | 41          |
...
| **yourselves** | себя;сами (вы) | - |
| **themselves** | себя;сами (они) | 447 |
| **self** | себя | 968 |
| **each other** | друг друга | - |
| **one another** | друг друга | - |
| **some** | некоторый;кое-какой | - |
...
| **many** | много (исчисляемое) | - |
| **few** | мало (исчисляемое) | - |
| **little** | мало (неисчисляемое) | - |
| **someone** | кто-то | 423 |
...
| Conjunction | Translate | Frequency | Тип |
| :--- | :--- | :--- | :--- |
| and | и | 3 | Сочинительный |
| but | но; однако | 23 | Сочинительный |
| or | или | 32 | Сочинительный |
| nor | ни | 1062 | Сочинительный |
| for | ибо; так как | - | Сочинительный |
| yet | однако; все же | - | Сочинительный |
| so | поэтому; так что | 1500 | Сочинительный |
| after | после того как | 180 | Подчинительный (Время) |
| although | хотя | 362 | Подчинительный (Уступка) |
| as | так как; в то время как; как; поскольку | 50 | Подчинительный (Причина/Время) |
| as if | как будто | - | Подчинительный (Сравнение) |
| as long as | пока; при условии что | - | Подчинительный (Условие) |
| as much as | столько же сколько | - | Подчинительный (Сравнение) |
| as soon as | как только | - | Подчинительный (Время) |
| as though | как будто | - | Подчинительный (Сравнение) |
| because | потому что | 91 | Подчинительный (Причина) |
| before | до того как; прежде; раньше | 707 | Подчинительный (Время) |
| by the time | к тому времени когда | - | Подчинительный (Время) |
| even if | даже если | - | Подчинительный (Условие) |
| even though | хотя; даже though | - | Подчинительный (Условие) |
| if | если | 42 | Подчинительный (Условие) |
| if only | если бы только | - | Подчинительный (Условие) |
| if then | если то | - | Подчинительный (Условие) |
| in case | в случае если | - | Подчинительный (Условие) |
| in order that | для того чтобы | - | Подчинительный (Цель) |
| lest | чтобы не | - | Подчинительный (Цель) |
| like | как будто | 1168 | Подчинительный (Сравнение) |
| now that | теперь когда; раз; когда | 1887 | Подчинительный (Время/Причина) |
| once | как только | 1209 | Подчинительный (Время) |
| only if | только если | - | Подчинительный (Условие) |
| provided that | при условии что | - | Подчинительный (Условие) |
| since | так как; с тех пор; с; после | 885 | Подчинительный (Причина/Время) |
| so that | так чтобы | - | Подчинительный (Цель) |
| than | чем; кроме; как | 74 | Подчинительный (Сравнение) |
| that | что; то | 7 | Подчинительный (Изъяснительный) |
| though | хотя | 255 | Подчинительный (Уступка) |
| till | до тех пор пока | - | Подчинительный (Время) |
| unless | если не; пока не | 1336 | Подчинительный (Условие) |
| until | до тех пор пока; до; до тех пор | 1383 | Подчинительный (Время) |
| when | когда | 60 | Подчинительный (Время) |
| whenever | всякий раз когда | - | Подчинительный (Время) |
| where | где | 194 | Подчинительный (Место) |
| whereas | тогда как | - | Подчинительный (Сопоставление) |
| wherever | где бы ни | - | Подчинительный (Место) |
| whether | ли | 325 | Подчинительный (Изъяснительный) |
| while | в то время как | 156 | Подчинительный (Время) |
| both... and... | как... так и... | - | Сочетающий |
| either... or... | или... или... | - | Сочетающий |
| neither... nor... | ни... ни... | - | Сочетающий |
| not only... but also... | не только... но и... | - | Сочетающий |
| whether... or... | ли... или... | - | Сочетающий |
| as... as... | такой же... как... | - | Сочетающий |
| such... that... | такой... что... | - | Сочетающий |
| scarcely... when... | едва... когда... | - | Сочетающий |
| rather than | скорее чем | - | Сочетающий |
| however | однако | - | Присоединительное наречие |
| therefore | следовательно | - | Присоединительное наречие |
| moreover | более того | - | Присоединительное наречие |
| furthermore | кроме того | - | Присоединительное наречие |
| nevertheless | тем не менее | - | Присоединительное наречие |
| otherwise | иначе | - | Присоединительное наречие |
| then | затем | - | Присоединительное наречие |
| thus | таким образом | - | Присоединительное наречие |
| hence | следовательно | - | Присоединительное наречие |
| accordingly | соответственно | - | Присоединительное наречие |
| consequently | следовательно | - | Присоединительное наречие |
| still | все же | - | Присоединительное наречие |
| instead | вместо | - | Присоединительное наречие |
| meanwhile | тем временем | - | Присоединительное наречие |
| indeed | действительно | - | Присоединительное наречие |
| nonetheless | тем не менее | - | Присоединительное наречие |
| except | если не | 1886 | Присоединительное наречие |
...
В общем, этих 760 основных слов достаточно для освоения грамматики A1 и развития навыка выражать свои мысли, чувства, хотелки ...
