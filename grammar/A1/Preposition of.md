...
Количественные существительные — это особые наборы слов, например фразы или термины, которые вы используете, чтобы обозначить количество определенных вещей.

Example: "Do you want **a bottle** of water? - Вы хотите бутылку воды?"

- **a pair of** - пара, для вещей которым нужны две одинаковые части, например: "a pair of gloves - пара перчаток"
- **a set of** - набор, для вещей которым требуется более одной отдельной детали, например: «a set of rules - набор правил»
- **a pack of** - пачка, для вещей в упаковке, например: «a pack of candy - пачка конфет»
- **a bar of** - плитка, например: «a bar of chocolate - плитка шоколада»
- **a scoop of** - ложка, для сыпучих вещей, например: «a scoop of ice cream - ложка мороженого»
- **a piece of** - кусок - это часть, созданная любыми способами (разрезанием, разрывом, разбиванием, откусыванием и т. д.) и любой формы и размера., например: «a piece of cake - кусок торта»
...
- **a bag of** popcorn	-	мешок попкорна
