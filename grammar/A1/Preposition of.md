...
Количественная оценка существительных
...
- **a pair of** - используется только для вещей, которым для формирования правильного набора нужны две одинаковые части, например. "a pair of gloves - пара перчаток"
- **a set of** - используется только для вещей, которым для формирования правильного набора требуется более одной отдельной детали, например. «a set of rules - набор правил»
