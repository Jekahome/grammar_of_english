...
Из этих предложений [создать аудио](https://github.com/Jekahome/grammar_of_english/blob/main/tools/gen_gTTS_from_file.py) в формате "EN - пауза - RU", прослушивать и писать их снова под диктовку.
