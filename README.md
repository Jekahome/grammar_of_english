...
- набора A1 (последовательно начиная с глаголов);
...
Кроме работы с отдельными словами, если еще две важные темы, которые обладают уникальным набором слов, реплик. И которые следует такого же сценария проработки как и слова.
