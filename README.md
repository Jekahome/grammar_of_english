...
2. Второй уровень, имея вариант на своем языке, сделать перевод, т.е. написать все предложение целиком.
3. Третий уровень, имея вариант на своем языке, сказать суть предложения на английском.
...
Имея собственно составленные предложения, а так же предложения из грамматики соответсвующего уровня A1... и адаптивных книг соответсвующего уровня A1..., переходим ко второму пункту.
...
Кроме работы с отдельными словами, есть еще две важные группы тем, которые обладают уникальным набором слов, реплик. И с которыми следует так же прорабатывать как и слова.
